            ...
            <div className="max-w-5xl relative z-10 w-full mx-auto">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                    <a
                        ...
                        className="hero-cta group relative inline-flex items-center justify-center gap-2 px-8 py-4 bg-navy text-white rounded-xl font-sans font-semibold hover:bg-navy/90 transition-all duration-300 overflow-hidden"
                    >
